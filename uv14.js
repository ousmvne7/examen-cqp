const uv14Questions = [
  {
    ...
    "correctText": "Le Plan d'Opération Interne ou équivalent",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    ...
    "correctText": "Dès lors que la durée prévisible des travaux est au moins égale à 400 heures sur une période d'un an",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    ...
    "correctText": "En cas de travaux dangereux listés dans l'arrêté de 19 mars 1993",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    ...
    "options": [
      ...
      "Améliorer les statistiques concernent les taux d'accidents du travail",
      "Aucune des autres réponses"
    ],
    "correctText": "Eviter ou limiter les dommages",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    "question": "Dans quel document l'APS peut trouver les mesures opératoires des secours extérieurs lors d'un sinistre majeur?",
    "options": [
      "Le Plan Particulier d'Intervention (PPI) ou équivalents",
      "Le Plan de Particulier des Risques Majeurs (PPRM)",
      "Le Plan de Secours Extérieur (PSE)",
      "Aucune des autres réponses",
      "Le Plan des Opérations Externes (POE)"
    ],
    "correctText": "Le Plan Particulier d'Intervention (PPI) ou équivalents",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    ...
    "options": [
      ...
      "Appliquer les consignes et plans d'interventions prévus",
      "Aucune des autres réponses",
      "Fuir, sinon se confiner et combattre les éléments naturels en dernier recours",
      "Eteindre tous les systèmes, rentrer chez soi et attendre la levée du plan"
    ],
    "correctText": "Appliquer les consignes et plans d'interventions prévus",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    ...
    "options": [
      ...
      "Il dispose d'un émetteur multi-fréquence",
      "Il dispose d'un matériel anti-déflagrant",
      "Il dispose d'une radio fabriquée après le 1 juillet 2017",
      "Aucune des autres réponses"
    ],
    "correctText": "Il dispose d'un matériel anti-déflagrant",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      "Je dois respecter les consignes",
      "d'hygiene du site client",
      "Aucune des autres réponses",
      "Je dispose d'une autorisation ATEX pour y pénétrer et je n'ai pas à les porter"
    ],
    "correctText": "Je dois respecter les consignes",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  },
  {
    "question": "Qu'est-ce qu'une ICPE?",
    "options": [
      "Une Installation Classifiée pour la Prévention des Evénements",
      "Une Installation Classée pour la Protection des Espaces verts",
      "Une Installation Classifiée pour la Prévention de l'Etat",
      "Aucune des autres réponses",
      "Une Installation Classée pour la Protection de l'Environnement"
    ],
    "correctText": "Une Installation Classée pour la Protection de l'Environnement",
    "tip": "En site industriel, la priorité est d'appliquer les plans, consignes de prévention, règles ICPE/SEVESO et procédures de sécurité du site."
  }
];
