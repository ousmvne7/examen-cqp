const uv10Questions = [
  ...
  },
  {
    ...
    "options": [
      "Aucune des autres réponses",
      "Vous vérifierez à la prise de service le bon fonctionnement des caméras conformément aux consignes",
      "Vous n'êtes pas habilité à vous servir de ce système n'ayant pas d'autorisation du CNAPS spécifique",
      "Vous ne vous servirez des caméras qu'en cas d'intrusion, quelles que soient les consignes",
      "Vous garderez chaque jour des copies d'images ou vidéos pour vous prémunir de tout reproche futur"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Délivrer les cartes d'agrément Vidéoprotecteur"
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Le taille de l'image et sa précision",
  ...
  },
  {
    ...
    "options": [
      ...
      "Je déclenche l'alarme générale d'évacuation des batiments",
  ...
  },
  {
    ...
    "options": [
      "Aucun incident n'ayant été relevé à cet instant, je ne fais que libèrer un peu de place sur le disque dur du serveur de stockage",
      "Aucune des autres réponses",
      "Je le lui laisse faire, ne souhaitant pas être impliqué dans cette action",
  ...
  },
  {
    ...
    "options": [
      "Non, car les enregistrements doivent restent toujours confidentiels",
      "Non, car seuls les opérateurs publics peuvent visionner des images privées",
      "Oui, après en avoir fait la demande auprès du Préfet",
      "Oui, sauf si le refus est justifié par les",
  ...
  },
  {
    ...
    "options": [
      "Le fait de ne conserver les images que pendant un mois au maximum sauf procédure judiciaire en cours",
      "Le fait d'utiliser des images à d'autres fins que celles autorisées",
      "Le fait de falsifier des enregistrements",
